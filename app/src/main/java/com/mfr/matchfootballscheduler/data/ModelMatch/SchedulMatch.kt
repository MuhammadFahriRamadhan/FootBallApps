...
data class MatchResponse(val events: List<SchedulMatch>)

data class SearchScMatchResponse(@SerializedName("event")
                               @Expose
                               var events: List<SchedulMatch>? = null)

@Parcelize
data class SchedulMatch(@SerializedName("idEvent")
                        @Expose
                        ...
                        var allLineupDetail: String? = (strHomeLineupGoalkeeper + "\n" +
                                strHomeLineupDefense + "\n" +
                                strHomeLineupMidfield + "\n" +
                                strHomeLineupForward).replace(";", ",\n"),

                        var allAwayLineupDetail: String? = (strAwayLineupGoalkeeper + "\n" +
                                strAwayLineupDefense + "\n" +
                                strAwayLineupMidfield + "\n" +
                                strAwayLineupForward).replace(";", ",\n")
) : Parcelable